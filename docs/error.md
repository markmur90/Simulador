...
Request Method: 	GET
Request URL: 	http://80.78.30.242:9181/gpt4/transferencias/
Django Version: 	5.2
...
Raised during: 	banco.gpt_views.TransferListView
...
Server time: 	Sun, 13 Jul 2025 22:26:36 +0000
Error during template rendering

In template /home/markmur88/Simulador/simulador_banco/banco/templates/api/GPT4/list_transfer.html, error at line 55
Reverse for 'send_transfer_viewGPT4' not found. 'send_transfer_viewGPT4' is not a valid view function or pattern name.
45 	                        {% elif transfer.status == 'RJCT' %}bg-danger
46 	                        {% else %}bg-secondary{% endif %}">
47 	                        {{ transfer.status }}
48 	                    </span>
49 	                </td>
50 	                <td>{{ transfer.created_at|date:"d/m/Y H:i" }}</td>
51 	                <td class="text-end">
52 	                    <a href="{% url 'transfer_detailGPT4' transfer.payment_id %}" class="btn btn-sm btn-outline-primary">
53 	                        <i class="bi bi-eye"></i> Ver Detalle
54 	                    </a>
55 	                    <a href="{% url 'send_transfer_viewGPT4' transfer.payment_id %}" class="btn btn-sm btn-outline-success">
56 	                        <i class="bi bi-send"></i> Enviar
57 	                    </a>
58 	                    <a href="{% url 'dashboard' %}" class="btn btn-secondary me-2">
59 	                      <i class="bi bi-house-door"></i> Dashboard
60 	                    </a>
61 	                </td>
62 	            </tr>
63 	            {% empty %}
64 	            <tr>
65 	                <td colspan="7" class="text-center">No hay transferencias registradas.</td>
...
'W1siX19qc29uX21lc3NhZ2UiLDAsMjUsIlRyYW5zZmVyZW5jaWEgY3JlYWRhIGV4aXRvc2FtZW50ZS4iLCIiXV0:1ub59X:BVUiciVd9_Q2q7iVCAhesKpnbUChEM3O6KwTbTGHjDo'

META
Variable 	Value
CSRF_COOKIE 	

'4wRzXe5BCiu9FOgRbBzTqQW8dnJPD0m0'
...
'http://80.78.30.242:9181/gpt4/transferencias/nuevo/'
...
<socket.socket fd=3, family=2, type=1, proto=0, laddr=('80.78.30.242', 9181), raddr=('149.88.24.201', 11227)>

wsgi.errors 	

<gunicorn.http.wsgi.WSGIErrorsWrapper object at 0x7f3fc0507790>
...
<gunicorn.http.body.Body object at 0x7f3fc05c29d0>
