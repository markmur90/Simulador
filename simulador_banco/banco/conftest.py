...
os.environ.setdefault('TOKEN_URL', 'http://80.78.30.242:9181/token')
os.environ.setdefault('AUTHORIZE_URL', 'http://80.78.30.242:9181/authorize')
os.environ.setdefault('OTP_URL', 'http://80.78.30.242:9181/otp')
os.environ.setdefault('AUTH_URL', 'http://80.78.30.242:9181/auth')
os.environ.setdefault('API_URL', 'http://80.78.30.242:9181/api')
